...
For details, see `docs/01_onnx_export.md`.
...
- Architecture details: `docs/04_architecture_design.md`
- Performance optimization: `docs/05_performance_optimization.md`
- C# optimization: `docs/06_csharp_optimization.md`
...
Third-party assets (models/dictionaries) may have separate terms. See `THIRD_PARTY_NOTICES.md`.
